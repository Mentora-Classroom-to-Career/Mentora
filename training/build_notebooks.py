    ...
    cells = [
        ...
        *SHARED_SETUP,
        ...
        code(
            ...
            "pos_weight = torch.clamp(pos_weight, max=20.0)  # cap -- uncapped weights hit 430 for the\n"
            "                                                  # thinnest classes (Calculus, Writing) on\n"
            "                                                  # the real dataset, which risks the same\n"
            "                                                  # loss-explosion instability seen before\n"
