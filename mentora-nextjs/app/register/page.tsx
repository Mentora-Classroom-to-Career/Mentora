...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const payload = {
      ...
      exam_goal: formData.get("exam_goal") as string,
    };
  ...
  return (
    ...
    >
      ...
      <form id="register-form" name="register-form" onSubmit={handleSubmit}>
        {error && (
        ...
        <div className="field-row">
          <div className="field">
            ...
            <input type="text" id="first_name" name="first_name" placeholder="e.g. Raimal" required autoComplete="given-name" />
          </div>
          <div className="field">
            <label htmlFor="last_name">Last Name</label>
            <input type="text" id="last_name" name="last_name" placeholder="e.g. Raja" required autoComplete="family-name" />
          </div>
        </div>
        ...
        <div className="field">
          ...
          <input type="text" id="university" name="university" placeholder="University of Sindh, Laar Campus" required autoComplete="organization" />
        </div>

        <div className="field">
          <label htmlFor="exam_goal">I am preparing for</label>
          <select id="exam_goal" name="exam_goal" required defaultValue="">
            <option value="" disabled>Select an exam or career goal</option>
      ...
      <p className="auth-legal">
        ...
        <Link href="/login" className="link-inline">Login here</Link>
      </p>
    </AuthShell>
  );
}
